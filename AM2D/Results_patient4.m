...
% ------------ 2D AM Paerametes ---------- %
% ---------------------------------------- %
midA = 11; % the seed RF-line where the displacement calculation starts from
alfa = 20; % axial regularization
beta = 20; % lateral regularization
gamma = 0.005; %lateral regularization 
T = .2; % threshold for IRLS
a_t = 1; % frequency dependent attenuation coefficient, in dB/cm/MHz
